...
train_name = "clothes_train_test06"
model_name = "COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_3x.yaml"

# register model
d = train_name
DatasetCatalog.register(d, lambda d = d: get_clothes_dicts(json_dir))
MetadataCatalog.get(d).set(thing_classes=["short_sleeved_shirt"])
clothes_metadata = MetadataCatalog.get(train_name)
